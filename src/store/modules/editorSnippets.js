const editorSnippets = {
  ...
  state: {
    ...
    columnBreakSnippet: '```\n```\n',
    wideBlockSnippet: '<div markdown="true" class="page-wide-block">\nwide_block\n</div>\n',
    verticalSpacingSnippet: '<div style="height: 350px;"></div>\n',
